...
CJNIEXPORT jobject JNICALL Java_StellarLikeTransactionBuilder_00024CppProxy_native_1setCorrelationId(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef, jstring j_correlationId)
{
    try {
        DJINNI_FUNCTION_PROLOGUE1(jniEnv, nativeRef);
        const auto& ref = ::djinni::objectFromHandleAddress<::ledger::core::api::StellarLikeTransactionBuilder>(nativeRef);
